...
const jobDetails = {
  '1': { description: 'As a Senior Frontend Engineer at Vercel, you will be at the forefront of building the next generation of web experiences. You will work with Next.js, React, and cutting-edge frontend technologies to deliver high-performance, scalable, and beautiful user interfaces.' },
